...
export const isPathSkintech = () => (window.location.pathname === '/skintech');
export const isPathBillGenius = () => (window.location.pathname === '/billgenius');
export const isPathEllev8 = () => (window.location.pathname === '/ellev8');
// export const isPathVibeRides = () => (window.location.pathname === '/viberides');
export const isPathIDecide = () => (window.location.pathname === '/idecide');
